...
function verifyUserAlreadyExists(email) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, authRepository.getUserByEmail(email)];
                case 1:
                    user = _a.sent();
...
function generateToken(email, userId) {
    return jwt.sign({ email: email, userId: userId }, process.env.JWT_SECRET, { expiresIn: "1h" });
}
...
export function signUp(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var userExist, hashPassword, user, token;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, verifyUserAlreadyExists(email)];
                case 1:
                    userExist = _b.sent();
                    if (userExist) {
                    ...
                    return [4 /*yield*/, authRepository.createUser(email, hashPassword)];
                case 2:
                    user = _b.sent();
                    token = generateToken(email, user.id);
                    return [4 /*yield*/, authRepository.createSession(token, user)];
                case 3:
                    _b.sent();
...
export function signIn(_a) {
    var email = _a.email, password = _a.password;
    return __awaiter(this, void 0, void 0, function () {
        var user, comparedPassword, token;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, verifyUserAlreadyExists(email)];
                case 1:
